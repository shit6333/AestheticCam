...
class UnifiedGaussianEnv(gym.Env):
    ...
    def step(self, action: np.ndarray):
        ...
        reward = aes_score * div_ratio * smo_ratio
        ...
        info = {"aesthetic":aes_score, "diversity":div_ratio, "smoothness":smo_ratio}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ply",type=str,default="/mnt/HDD3/miayan/omega/RL/gaussian-splatting/output/room_midnerf/point_cloud/iteration_30000/point_cloud.ply")
    ...
    env = UnifiedGaussianEnv(
        ...
        device=args.device,
        sh_degree=3,
        images_bin = '/mnt/HDD3/miayan/omega/RL/gaussian-splatting/data/room/sparse/0/images.bin'
    )
